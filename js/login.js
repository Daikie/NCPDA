			...
			if(enc.length == 8) {
				...
				csvReq.onload = function() {
					...
					if(chk % 10 == ida[0]) {
						...
						htm += "<h3>初診の受付制限に伴い、処置予約枠を増やします</h3>";
						htm += "<p>再診の方が受診しやすいよう、初診の受付方法を変更しました。<a href='notification.html' target='_blank'>詳細はこちら</a>";
						htm += "<br>それに伴い、継続的な治療が必要な方のために処置予約枠を増やします。";
						htm += "今までの9:00と15:00の枠に加えて、<span class='markR'>午前及び午後の遅めの時間帯に枠を新設</span>します。</p>";
						htm += "<ul><li>月・火・木・金・土午前は9:00と11:00</li><li>月午後は15:00と18:00</li><li>火午後は15:00と17:00</li></ul>";
						htm += "<p>処置予約枠は初診の受付を制限することで捻出しておりますので、くれぐれも予約をお忘れにならないよお願いいたします。";
						htm += "予約取得後にご都合が合わなくなった場合は必ずキャンセル処理をなさってください。</p>";
						htm += "<hr>";
